...
class Salon {
  ...
  Salon({required this.name, required this.location, required this.services,
    ...
    required this.ratings, required this.ratingnumbers, required this.serviceRatings, required this.servicePrices,
  });
  ...
  String getServicePrice(String service) {
    return servicePrices[service] ?? startFrom;
  }
}

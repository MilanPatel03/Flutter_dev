...
import 'package:salonverse/UI/Profile/Model/GetProfileModel.dart';

import '../../../Data/Services/ApiServices/ApiServices.dart';
import 'EditProfileProfileController.dart';
...
class GetProfileController extends GetxController {
  ...
  final EditProfileController _editProfileProfileCont_obj = Get.put(EditProfileController());
  ...
  Future<void> getProfileCont () async  {
    ...
    try {
      ...
      if(newResponse.responseCode == 1 ){
        ...
        _editProfileProfileCont_obj.mobileNumber.text = data!.mobileNumber.toString();

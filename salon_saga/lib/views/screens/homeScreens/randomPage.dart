...
import '../categories/mensCategories/mensServiceCategories.dart';
import '../categories/womensCategories/womenCategories.dart';
import '../nearBySalons/nearBySalon01.dart';
import '../nearBySalons/nearBySalon02.dart';
import '../nearBySalons/nearBySalon03.dart';
...
class _RandompageState extends State<Randompage> {
  ...
  String locationOfUser = "Fetching location...";

  void _initializeLocation() async {
    await LocationService.getCurrentLocation((location) {
      setState(() {
  ...
  final List<AssetImage> nearBySalons = [
    ...
    const AssetImage("assets/SalonAppAssets/homepageCard03.jpg"),
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                return Column(
                  children: [
                    ...
                    if (index == 0) firstHomeSliver(context),
                    if (index == 0) const SizedBox(height: 8.0),
                    if (index == 0) secondHomeSliver(context),
                    if (index == 0) const SizedBox(height: 8.0),
                    if (index == 0) thirdHomeSliver(context),
                  ],
                );
              },
              childCount: 1,
  ...
  Widget firstHomeSliver(BuildContext context) {
  ...
  Widget secondHomeSliver(BuildContext context) {
  ...
  Widget thirdHomeSliver(BuildContext context) {
                                ...
                                onTap: () {
                                  if (index == 0) {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => const Nearbysalon01()),
                                    );
                                  } else if (index == 1) {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => const Nearbysalon02()),
                                    );
                                  } else if (index == 2) {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => const Nearbysalon03()),
                                    );
